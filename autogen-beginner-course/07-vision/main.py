...
user_proxy.initiate_chat(
    image_agent,
    message=f"""
        Can you describe this image in detail? And What is this Image Name? <img {image_mitochondria}>
    """
)
